...
def main():
    ...
    comparisons = [
        # ── arn→es ────────────────────────────────────────────────────────
        ("3.3B-arn-es",                    "3.3B-blocks-arn-es-cascade",
         "3.3B standard",                  "3.3B cascade"),
        ("3.3B-arn-es-morfessor",          "3.3B-blocks-arn-es-cascade",
         "3.3B morfessor",                 "3.3B cascade"),
        ("1.3B-arn-es-morfessor",          "1.3B-blocks-arn-es-cascade",
         "1.3B morfessor",                 "1.3B cascade"),
        ("3.3B-arn-es",                    "3.3B-arn-es-morfessor",
         "3.3B standard",                  "3.3B morfessor"),
        ("600M-arn-es-morfessor",          "3.3B-arn-es",
         "600M morfessor",                 "3.3B standard"),
        ("600M-blocks-arn-es-cascade",     "3.3B-arn-es",
         "600M cascade",                   "3.3B standard"),
        ("3.3B-blocks-arn-es-duan_bpe",    "3.3B-blocks-arn-es-cascade",
         "3.3B duan_bpe",                  "3.3B cascade"),
        ("3.3B-blocks-arn-es-large_bpe",   "3.3B-blocks-arn-es-cascade",
         "3.3B large_bpe",                 "3.3B cascade"),
        # ── es→arn ────────────────────────────────────────────────────────
        ("3.3B-es-arn",                    "3.3B-blocks-es-arn-cascade",
         "3.3B standard",                  "3.3B cascade"),
        ("3.3B-es-arn",                    "3.3B-es-arn-morfessor",
         "3.3B standard",                  "3.3B morfessor"),
        ("1.3B-es-arn",                    "1.3B-blocks-es-arn-cascade",
         "1.3B standard",                  "1.3B cascade"),
    ]
